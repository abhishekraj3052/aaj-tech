  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        console.error('Error fetching EV products:', error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative bg-brand-red pt-40 pb-24 overflow-hidden mt-16 lg:mt-0">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-7xl font-black text-white mb-4 md:mb-6 tracking-tight">EV Products</h1>
            <div className="flex items-center gap-2 text-white/80 font-bold text-xs md:text-sm tracking-widest uppercase flex-wrap">
              ...
              <Link href="/about-ev" className="hover:text-white transition-colors">EV Solution</Link>
              <ChevronRight size={14} />
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <motion.div {...fadeInUp} className="mb-12 md:mb-20">
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-brand-dark mb-6 md:mb-8 tracking-tight">
              EV Cabling & Charging Solutions
            </h2>
            <div className="space-y-6 text-gray-600 text-base sm:text-xl leading-relaxed font-medium max-w-5xl">
              <p>
                At <span className="text-brand-red font-black">Aaj Tech Trading Corporation</span>, we deliver custom-engineered EV connectivity products built for maximum conductivity, thermal resilience, and absolute safety.
              </p>
              <p>
                Whether you need high-power AC/DC charging guns, heavy-duty battery interconnect busbars, or delicate low-signal BMS terminal harnesses, we design each solution to match your exact electrical load, layout, and waterproofing standard.
              </p>
              <p className="text-brand-dark font-bold pt-4">
                Explore our catalog of certified Electric Vehicle connectivity products:
              </p>
            </div>
          </motion.div>
