...
const WhatsAppButton = () => {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-28 right-8 z-[60] bg-[#25D366] text-white p-4 rounded-full shadow-2xl flex items-center justify-center group cursor-grab active:cursor-grabbing border-none outline-none"
    ...
    >
      ...
      <span className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-25 -z-10"></span>
    </motion.button>
  );
};
